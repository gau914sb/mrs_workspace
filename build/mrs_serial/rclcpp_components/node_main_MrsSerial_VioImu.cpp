...
#define NODE_MAIN_LOGGER_NAME "MrsSerial_VioImu"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libMrsSerial_VioImu_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vio_imu::VioImu>";
