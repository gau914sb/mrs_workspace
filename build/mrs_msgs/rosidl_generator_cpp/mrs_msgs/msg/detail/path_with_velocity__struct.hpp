...
#ifndef MRS_MSGS__MSG__DETAIL__PATH_WITH_VELOCITY__STRUCT_HPP_
#define MRS_MSGS__MSG__DETAIL__PATH_WITH_VELOCITY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mrs_msgs__msg__PathWithVelocity __attribute__((deprecated))
#else
# define DEPRECATED__mrs_msgs__msg__PathWithVelocity __declspec(deprecated)
#endif
...
{
  using Type = PathWithVelocity_<ContainerAllocator>;

  explicit PathWithVelocity_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit PathWithVelocity_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using _points_type =
    std::vector<mrs_msgs::msg::ReferenceWithVelocity_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mrs_msgs::msg::ReferenceWithVelocity_<ContainerAllocator>>>;
  _points_type points;
  ...
  Type & set__points(
    const std::vector<mrs_msgs::msg::ReferenceWithVelocity_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mrs_msgs::msg::ReferenceWithVelocity_<ContainerAllocator>>> & _arg)
  {
    this->points = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    mrs_msgs::msg::PathWithVelocity_<ContainerAllocator> *;
  using ConstRawPtr =
    const mrs_msgs::msg::PathWithVelocity_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mrs_msgs::msg::PathWithVelocity_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mrs_msgs__msg__PathWithVelocity
    std::shared_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mrs_msgs__msg__PathWithVelocity
    std::shared_ptr<mrs_msgs::msg::PathWithVelocity_<ContainerAllocator> const>
  ...
  bool operator==(const PathWithVelocity_ & other) const
  {
...
using PathWithVelocity =
  mrs_msgs::msg::PathWithVelocity_<std::allocator<void>>;
...
#endif  // MRS_MSGS__MSG__DETAIL__PATH_WITH_VELOCITY__STRUCT_HPP_
