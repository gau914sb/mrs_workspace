...
#ifndef MRS_MSGS__MSG__DETAIL__GRIPPER_DIAGNOSTICS__TRAITS_HPP_
#define MRS_MSGS__MSG__DETAIL__GRIPPER_DIAGNOSTICS__TRAITS_HPP_
...
inline void to_yaml(
  const mrs_msgs::msg::GripperDiagnostics & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mrs_msgs::msg::GripperDiagnostics & msg)
{
  return mrs_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mrs_msgs::msg::GripperDiagnostics>()
{
  return "mrs_msgs::msg::GripperDiagnostics";
}

template<>
inline const char * name<mrs_msgs::msg::GripperDiagnostics>()
{
  return "mrs_msgs/msg/GripperDiagnostics";
}

template<>
struct has_fixed_size<mrs_msgs::msg::GripperDiagnostics>
  : std::integral_constant<bool, has_fixed_size<builtin_interfaces::msg::Time>::value> {};

template<>
struct has_bounded_size<mrs_msgs::msg::GripperDiagnostics>
  : std::integral_constant<bool, has_bounded_size<builtin_interfaces::msg::Time>::value> {};

template<>
struct is_message<mrs_msgs::msg::GripperDiagnostics>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MRS_MSGS__MSG__DETAIL__GRIPPER_DIAGNOSTICS__TRAITS_HPP_
