...
#include "mrs_msgs/msg/detail/reference_with_velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::ReferenceWithVelocity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::ReferenceWithVelocity & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::ReferenceWithVelocity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ReferenceWithVelocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::ReferenceWithVelocity *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ReferenceWithVelocity__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ReferenceWithVelocity *>(
...
static size_t _ReferenceWithVelocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ReferenceWithVelocity(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ReferenceWithVelocity__callbacks = {
  "mrs_msgs::msg",
...
static rosidl_message_type_support_t _ReferenceWithVelocity__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ReferenceWithVelocity__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ReferenceWithVelocity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, ReferenceWithVelocity)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ReferenceWithVelocity__handle;
}
