...
#include "mrs_msgs/msg/detail/gps_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::GpsData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::GpsData & ros_message)
{
  // Member: latitude
  cdr >> ros_message.latitude;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::GpsData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::GpsData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::GpsData *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_GpsData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, GpsData)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_GpsData__handle;
}
