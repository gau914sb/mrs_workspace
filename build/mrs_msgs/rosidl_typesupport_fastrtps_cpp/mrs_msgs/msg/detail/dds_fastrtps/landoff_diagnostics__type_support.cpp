...
#include "mrs_msgs/msg/detail/landoff_diagnostics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::LandoffDiagnostics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::LandoffDiagnostics & ros_message)
{
  // Member: stamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_LandoffDiagnostics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::LandoffDiagnostics;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_key_LandoffDiagnostics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::LandoffDiagnostics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::LandoffDiagnostics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LandoffDiagnostics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::LandoffDiagnostics *>(
...
static size_t _LandoffDiagnostics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LandoffDiagnostics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LandoffDiagnostics__callbacks = {
  "mrs_msgs::msg",
  "LandoffDiagnostics",
...
static rosidl_message_type_support_t _LandoffDiagnostics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LandoffDiagnostics__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_LandoffDiagnostics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, LandoffDiagnostics)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_LandoffDiagnostics__handle;
}
