...
#include "mrs_msgs/msg/detail/reference__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::Reference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::Reference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::Reference *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Reference__handle;
}
