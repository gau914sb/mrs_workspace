...
#include "mrs_msgs/msg/detail/velocity_reference__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::VelocityReference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::VelocityReference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::VelocityReference *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VelocityReference__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::VelocityReference *>(
...
static size_t _VelocityReference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VelocityReference(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VelocityReference__callbacks = {
  "mrs_msgs::msg",
  "VelocityReference",
...
static rosidl_message_type_support_t _VelocityReference__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VelocityReference__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_VelocityReference__handle;
}
