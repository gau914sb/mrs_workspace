...
#include "mrs_msgs/msg/detail/errorgraph_element__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mrs_msgs::msg::ErrorgraphError &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const mrs_msgs::msg::ErrorgraphElement & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::ErrorgraphElement & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  // Member: errors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ErrorgraphError(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::ErrorgraphElement;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: errors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ErrorgraphError(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ErrorgraphElement *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::ErrorgraphElement *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ErrorgraphElement__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ErrorgraphElement *>(
...
static size_t _ErrorgraphElement__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ErrorgraphElement(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ErrorgraphElement__callbacks = {
  "mrs_msgs::msg",
  "ErrorgraphElement",
...
static rosidl_message_type_support_t _ErrorgraphElement__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ErrorgraphElement__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ErrorgraphElement__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, ErrorgraphElement)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ErrorgraphElement__handle;
}
