...
#include "mrs_msgs/msg/detail/trajectory_reference__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::TrajectoryReference & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::TrajectoryReference & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::TrajectoryReference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::TrajectoryReference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::TrajectoryReference *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrajectoryReference__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::TrajectoryReference *>(
...
static size_t _TrajectoryReference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrajectoryReference(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrajectoryReference__callbacks = {
  "mrs_msgs::msg",
  "TrajectoryReference",
...
static rosidl_message_type_support_t _TrajectoryReference__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrajectoryReference__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryReference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, TrajectoryReference)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryReference__handle;
}
