...
#include "mrs_msgs/msg/detail/obstacle_sectors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::ObstacleSectors & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: sectors
  {
    cdr << ros_message.sectors;
  }

  // Member: sector_sensors
  {
    cdr << ros_message.sector_sensors;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::ObstacleSectors & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: sectors
  {
    ...
    size_t item_size = sizeof(ros_message.sectors[0]);
  ...
  // Member: sector_sensors
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.sector_sensors[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_ObstacleSectors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::ObstacleSectors;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_key_ObstacleSectors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ObstacleSectors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::ObstacleSectors *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObstacleSectors__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ObstacleSectors *>(
...
static size_t _ObstacleSectors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObstacleSectors(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObstacleSectors__callbacks = {
  "mrs_msgs::msg",
  "ObstacleSectors",
...
static rosidl_message_type_support_t _ObstacleSectors__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObstacleSectors__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ObstacleSectors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, ObstacleSectors)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ObstacleSectors__handle;
}
