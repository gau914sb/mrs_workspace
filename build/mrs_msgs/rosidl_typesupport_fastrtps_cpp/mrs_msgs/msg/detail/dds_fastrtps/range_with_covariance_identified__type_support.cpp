...
#include "mrs_msgs/msg/detail/range_with_covariance_identified__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::RangeWithCovarianceIdentified & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::RangeWithCovarianceIdentified & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::RangeWithCovarianceIdentified;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RangeWithCovarianceIdentified *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::RangeWithCovarianceIdentified *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RangeWithCovarianceIdentified__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RangeWithCovarianceIdentified *>(
...
static size_t _RangeWithCovarianceIdentified__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RangeWithCovarianceIdentified(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RangeWithCovarianceIdentified__callbacks = {
  "mrs_msgs::msg",
...
static rosidl_message_type_support_t _RangeWithCovarianceIdentified__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RangeWithCovarianceIdentified__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RangeWithCovarianceIdentified__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, RangeWithCovarianceIdentified)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RangeWithCovarianceIdentified__handle;
}
