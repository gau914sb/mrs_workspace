...
#include "mrs_msgs/msg/detail/custom_topic__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::CustomTopic & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::CustomTopic & ros_message)
{
  // Member: topic_name
  cdr >> ros_message.topic_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::CustomTopic;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::CustomTopic *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::CustomTopic *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CustomTopic__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::CustomTopic *>(
...
static size_t _CustomTopic__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CustomTopic(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CustomTopic__callbacks = {
  "mrs_msgs::msg",
  "CustomTopic",
...
static rosidl_message_type_support_t _CustomTopic__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CustomTopic__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_CustomTopic__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, CustomTopic)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_CustomTopic__handle;
}
