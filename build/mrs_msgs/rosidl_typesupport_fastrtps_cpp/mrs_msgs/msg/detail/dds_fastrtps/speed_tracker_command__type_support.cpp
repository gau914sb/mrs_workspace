...
#include "mrs_msgs/msg/detail/speed_tracker_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::SpeedTrackerCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::SpeedTrackerCommand & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_SpeedTrackerCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::SpeedTrackerCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_key_SpeedTrackerCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::SpeedTrackerCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::SpeedTrackerCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeedTrackerCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::SpeedTrackerCommand *>(
...
static size_t _SpeedTrackerCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeedTrackerCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeedTrackerCommand__callbacks = {
  "mrs_msgs::msg",
  "SpeedTrackerCommand",
...
static rosidl_message_type_support_t _SpeedTrackerCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeedTrackerCommand__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_SpeedTrackerCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, SpeedTrackerCommand)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_SpeedTrackerCommand__handle;
}
