...
#include "mrs_msgs/msg/detail/controller_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::ControllerStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::ControllerStatus & ros_message)
{
  // Member: active
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::ControllerStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::ControllerStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::ControllerStatus *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ControllerStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, ControllerStatus)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_ControllerStatus__handle;
}
