...
#include "mrs_msgs/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::Path & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::Path;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, Path)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
