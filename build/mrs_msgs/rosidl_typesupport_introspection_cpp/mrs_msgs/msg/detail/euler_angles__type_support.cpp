...
{
  new (message_memory) mrs_msgs::msg::EulerAngles(_init);
}

void EulerAngles_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_msgs::msg::EulerAngles *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EulerAngles_message_member_array[3] = {
  {
    ...
    offsetof(mrs_msgs::msg::EulerAngles, yaw),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::EulerAngles, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::EulerAngles, roll),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EulerAngles_message_members = {
  ...
  3,  // number of fields
  sizeof(mrs_msgs::msg::EulerAngles),
...
{
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::EulerAngles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_msgs, msg, EulerAngles)() {
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::EulerAngles_message_type_support_handle;
}
