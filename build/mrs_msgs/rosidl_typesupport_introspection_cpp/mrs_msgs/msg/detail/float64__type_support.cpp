...
{
  new (message_memory) mrs_msgs::msg::Float64(_init);
}

void Float64_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_msgs::msg::Float64 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float64_message_member_array[1] = {
  {
    ...
    offsetof(mrs_msgs::msg::Float64, value),  // bytes offset in struct
...
{
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::Float64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_msgs, msg, Float64)() {
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::Float64_message_type_support_handle;
}
