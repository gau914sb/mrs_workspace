...
{
  new (message_memory) mrs_msgs::msg::ControllerStatus(_init);
}

void ControllerStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_msgs::msg::ControllerStatus *>(message_memory);
  typed_message->~ControllerStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ControllerStatus_message_member_array[1] = {
  {
    "active",  // name
    ...
    offsetof(mrs_msgs::msg::ControllerStatus, active),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControllerStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(mrs_msgs::msg::ControllerStatus),
...
get_message_type_support_handle<mrs_msgs::msg::ControllerStatus>()
{
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::ControllerStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_msgs, msg, ControllerStatus)() {
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::ControllerStatus_message_type_support_handle;
}
