...
{
  new (message_memory) mrs_msgs::msg::Float64MultiArrayStamped(_init);
}

void Float64MultiArrayStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_msgs::msg::Float64MultiArrayStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float64MultiArrayStamped_message_member_array[2] = {
  {
    ...
    offsetof(mrs_msgs::msg::Float64MultiArrayStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::Float64MultiArrayStamped, matrix),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float64MultiArrayStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(mrs_msgs::msg::Float64MultiArrayStamped),
...
{
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::Float64MultiArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_msgs, msg, Float64MultiArrayStamped)() {
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::Float64MultiArrayStamped_message_type_support_handle;
}
