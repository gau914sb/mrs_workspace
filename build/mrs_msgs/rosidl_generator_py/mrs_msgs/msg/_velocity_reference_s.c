...
bool mrs_msgs__msg__velocity_reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._velocity_reference.VelocityReference", full_classname_dest, 50) == 0);
  }
  mrs_msgs__msg__VelocityReference * ros_message = _ros_message;
  {  // velocity
  ...
  {  // use_altitude
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_altitude");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_altitude = (Py_True == field);
    Py_DECREF(field);
  }
  {  // use_heading
...
{
  /* NOTE(esteve): Call constructor of VelocityReference */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._velocity_reference");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VelocityReference");
  ...
  {  // use_altitude
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_altitude ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_altitude", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
