...
bool mrs_msgs__msg__reference_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._reference_stamped.ReferenceStamped", full_classname_dest, 48) == 0);
  }
  mrs_msgs__msg__ReferenceStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ReferenceStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._reference_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ReferenceStamped");
