...
bool mrs_msgs__msg__image_labeled__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._image_labeled.ImageLabeled", full_classname_dest, 40) == 0);
  }
  mrs_msgs__msg__ImageLabeled * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of ImageLabeled */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._image_labeled");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageLabeled");
