...
bool mrs_msgs__msg__path_reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._path_reference.PathReference", full_classname_dest, 42) == 0);
  }
  mrs_msgs__msg__PathReference * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PathReference */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._path_reference");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathReference");
