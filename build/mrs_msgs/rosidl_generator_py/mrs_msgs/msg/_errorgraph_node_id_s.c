...
bool mrs_msgs__msg__errorgraph_node_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._errorgraph_node_id.ErrorgraphNodeID", full_classname_dest, 49) == 0);
  }
  mrs_msgs__msg__ErrorgraphNodeID * ros_message = _ros_message;
  {  // node
...
{
  /* NOTE(esteve): Call constructor of ErrorgraphNodeID */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._errorgraph_node_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ErrorgraphNodeID");
