...
bool mrs_msgs__msg__rtk_fix_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._rtk_fix_type.RtkFixType", full_classname_dest, 37) == 0);
  }
  mrs_msgs__msg__RtkFixType * ros_message = _ros_message;
  {  // fix_type
...
{
  /* NOTE(esteve): Call constructor of RtkFixType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._rtk_fix_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RtkFixType");
