...
bool mrs_msgs__msg__point2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._point2_d.Point2D", full_classname_dest, 30) == 0);
  }
  mrs_msgs__msg__Point2D * ros_message = _ros_message;
  {  // x
...
PyObject * mrs_msgs__msg__point2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._point2_d");
