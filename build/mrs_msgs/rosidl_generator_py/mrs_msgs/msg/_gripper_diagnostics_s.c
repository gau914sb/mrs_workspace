...
bool mrs_msgs__msg__gripper_diagnostics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._gripper_diagnostics.GripperDiagnostics", full_classname_dest, 52) == 0);
  }
  mrs_msgs__msg__GripperDiagnostics * ros_message = _ros_message;
  {  // stamp
...
PyObject * mrs_msgs__msg__gripper_diagnostics__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._gripper_diagnostics");
