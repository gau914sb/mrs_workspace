...
class Metaclass_HwApiAttitudeRateCmd(type):
    """Metaclass of message 'HwApiAttitudeRateCmd'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hw_api_attitude_rate_cmd
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hw_api_attitude_rate_cmd
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hw_api_attitude_rate_cmd
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hw_api_attitude_rate_cmd
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hw_api_attitude_rate_cmd
...
class HwApiAttitudeRateCmd(metaclass=Metaclass_HwApiAttitudeRateCmd):
    """Message class 'HwApiAttitudeRateCmd'."""
