...
bool mrs_msgs__msg__mpc_prediction_full_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._mpc_prediction_full_state.MpcPredictionFullState", full_classname_dest, 62) == 0);
  }
  mrs_msgs__msg__MpcPredictionFullState * ros_message = _ros_message;
  {  // header
  ...
  {  // attitude_rate
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'attitude_rate'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Vector3 * dest = ros_message->attitude_rate.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // acceleration
    ...
    geometry_msgs__msg__Vector3 * dest = ros_message->acceleration.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__vector3__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // jerk
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'jerk'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Vector3 * dest = ros_message->jerk.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__vector3__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // heading
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->heading.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'heading'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // heading_rate
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->heading_rate.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'heading_rate'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // heading_acceleration
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->heading_acceleration.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'heading_acceleration'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // heading_jerk
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->heading_jerk.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'heading_jerk'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of MpcPredictionFullState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._mpc_prediction_full_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MpcPredictionFullState");
  ...
  {  // attitude_rate
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->attitude_rate.data[i]);
  ...
  {  // heading
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "heading");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->heading.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->heading.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->heading.size * sizeof(double));
      assert(data != NULL);
  ...
  {  // heading_rate
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "heading_rate");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->heading_rate.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->heading_rate.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->heading_rate.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // heading_acceleration
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "heading_acceleration");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->heading_acceleration.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->heading_acceleration.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->heading_acceleration.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // heading_jerk
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "heading_jerk");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->heading_jerk.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->heading_jerk.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->heading_jerk.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
