...
bool mrs_msgs__msg__profiler_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._profiler_update.ProfilerUpdate", full_classname_dest, 44) == 0);
  }
  mrs_msgs__msg__ProfilerUpdate * ros_message = _ros_message;
  {  // stamp
  ...
  {  // routine_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "routine_name");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->routine_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // iteration
    ...
    ros_message->iteration = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // duration
...
{
  /* NOTE(esteve): Call constructor of ProfilerUpdate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._profiler_update");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProfilerUpdate");
  ...
  {  // routine_name
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->routine_name.data,
      strlen(ros_message->routine_name.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "routine_name", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // iteration
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->iteration);
    {
