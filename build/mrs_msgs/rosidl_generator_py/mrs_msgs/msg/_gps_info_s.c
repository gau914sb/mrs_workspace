...
bool mrs_msgs__msg__gps_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._gps_info.GpsInfo", full_classname_dest, 30) == 0);
  }
  mrs_msgs__msg__GpsInfo * ros_message = _ros_message;
  {  // stamp
  ...
  {  // vel_acc
    ...
    assert(PyFloat_Check(field));
    ros_message->vel_acc = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // hdg_acc
    ...
    assert(PyFloat_Check(field));
    ros_message->hdg_acc = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // yaw
  ...
  {  // dgps_num_sats
    PyObject * field = PyObject_GetAttrString(_pymsg, "dgps_num_sats");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->dgps_num_sats = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // dgps_age
    ...
    assert(PyFloat_Check(field));
    ros_message->dgps_age = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // baseline_dist
    PyObject * field = PyObject_GetAttrString(_pymsg, "baseline_dist");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->baseline_dist = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * mrs_msgs__msg__gps_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._gps_info");
  ...
  {  // vel_acc
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->vel_acc);
    {
  ...
  {  // hdg_acc
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->hdg_acc);
    {
  ...
  {  // dgps_num_sats
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->dgps_num_sats);
    {
      int rc = PyObject_SetAttrString(_pymessage, "dgps_num_sats", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // dgps_age
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->dgps_age);
    {
  ...
  {  // baseline_dist
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->baseline_dist);
    {
      int rc = PyObject_SetAttrString(_pymessage, "baseline_dist", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
