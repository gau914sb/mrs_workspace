...
bool mrs_msgs__msg__hw_api_attitude_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._hw_api_attitude_cmd.HwApiAttitudeCmd", full_classname_dest, 50) == 0);
  }
  mrs_msgs__msg__HwApiAttitudeCmd * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of HwApiAttitudeCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._hw_api_attitude_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HwApiAttitudeCmd");
