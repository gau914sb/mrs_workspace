...
bool mrs_msgs__msg__controller_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._controller_status.ControllerStatus", full_classname_dest, 48) == 0);
  }
  mrs_msgs__msg__ControllerStatus * ros_message = _ros_message;
  {  // active
...
PyObject * mrs_msgs__msg__controller_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._controller_status");
