...
bool mrs_msgs__msg__reference_with_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * mrs_msgs__msg__reference_with_velocity__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool mrs_msgs__msg__path_with_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._path_with_velocity.PathWithVelocity", full_classname_dest, 49) == 0);
  }
  mrs_msgs__msg__PathWithVelocity * ros_message = _ros_message;
  {  // header
  ...
  {  // points
    ...
    if (!mrs_msgs__msg__ReferenceWithVelocity__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mrs_msgs__msg__ReferenceWithVelocity__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mrs_msgs__msg__ReferenceWithVelocity * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mrs_msgs__msg__reference_with_velocity__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of PathWithVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._path_with_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathWithVelocity");
  ...
  {  // points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mrs_msgs__msg__reference_with_velocity__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
