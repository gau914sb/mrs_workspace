...
bool mrs_msgs__msg__hw_api_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._hw_api_status.HwApiStatus", full_classname_dest, 39) == 0);
  }
  mrs_msgs__msg__HwApiStatus * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of HwApiStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._hw_api_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HwApiStatus");
