...
bool mrs_msgs__msg__constraint_manager_diagnostics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._constraint_manager_diagnostics.ConstraintManagerDiagnostics", full_classname_dest, 73) == 0);
  }
  mrs_msgs__msg__ConstraintManagerDiagnostics * ros_message = _ros_message;
  {  // stamp
  ...
  {  // current_values
    ...
    if (!mrs_msgs__msg__dynamics_constraints__convert_from_py(field, &ros_message->current_values)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ConstraintManagerDiagnostics */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._constraint_manager_diagnostics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConstraintManagerDiagnostics");
  ...
  {  // current_values
    PyObject * field = NULL;
    field = mrs_msgs__msg__dynamics_constraints__convert_to_py(&ros_message->current_values);
    if (!field) {
      return NULL;
    }
    {
