...
#include "mrs_msgs/msg/detail/track__rosidl_typesupport_fastrtps_c.h"
...
using _Track__ros_msg_type = mrs_msgs__msg__Track;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Track;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Track * ros_message = static_cast<const mrs_msgs__msg__Track *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Track(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Track * ros_message = static_cast<mrs_msgs__msg__Track *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Track(cdr, ros_message);
}

static uint32_t _Track__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Track(
...
static size_t _Track__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__Track(
