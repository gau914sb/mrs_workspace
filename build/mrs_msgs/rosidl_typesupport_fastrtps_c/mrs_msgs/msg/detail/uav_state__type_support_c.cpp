...
#include "mrs_msgs/msg/detail/uav_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/accel__functions.h"  // acceleration, acceleration_disturbance
#include "geometry_msgs/msg/detail/pose__functions.h"  // pose
#include "geometry_msgs/msg/detail/twist__functions.h"  // velocity
#include "rosidl_runtime_c/string.h"  // child_frame_id, estimator_heading, estimator_horizontal, estimator_vertical
#include "rosidl_runtime_c/string_functions.h"  // child_frame_id, estimator_heading, estimator_horizontal, estimator_vertical
...
using _UavState__ros_msg_type = mrs_msgs__msg__UavState;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_mrs_msgs__msg__UavState(
  const mrs_msgs__msg__UavState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: acceleration_disturbance
  {
    cdr_serialize_geometry_msgs__msg__Accel(
      &ros_message->acceleration_disturbance, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_deserialize_mrs_msgs__msg__UavState(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__UavState * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: acceleration_disturbance
  {
    cdr_deserialize_geometry_msgs__msg__Accel(cdr, &ros_message->acceleration_disturbance);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_mrs_msgs__msg__UavState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_mrs_msgs__msg__UavState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__UavState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_key_mrs_msgs__msg__UavState(
  const mrs_msgs__msg__UavState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_key_mrs_msgs__msg__UavState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UavState__ros_msg_type * ros_message = static_cast<const _UavState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_key_mrs_msgs__msg__UavState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__UavState * ros_message = static_cast<const mrs_msgs__msg__UavState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__UavState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__UavState * ros_message = static_cast<mrs_msgs__msg__UavState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__UavState(cdr, ros_message);
}

static uint32_t _UavState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__UavState(
...
static size_t _UavState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__UavState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, UavState)() {
