...
#include "mrs_msgs/msg/detail/point2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Point2D__ros_msg_type = mrs_msgs__msg__Point2D;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Point2D * ros_message = static_cast<const mrs_msgs__msg__Point2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Point2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Point2D * ros_message = static_cast<mrs_msgs__msg__Point2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Point2D(cdr, ros_message);
}

static uint32_t _Point2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Point2D(
...
static size_t _Point2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__Point2D(
