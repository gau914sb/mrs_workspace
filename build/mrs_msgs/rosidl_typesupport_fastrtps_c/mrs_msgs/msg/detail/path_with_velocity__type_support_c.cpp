...
#include "mrs_msgs/msg/detail/path_with_velocity__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/reference_with_velocity__functions.h"  // points
...
using _PathWithVelocity__ros_msg_type = mrs_msgs__msg__PathWithVelocity;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_mrs_msgs__msg__PathWithVelocity(
  const mrs_msgs__msg__PathWithVelocity * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__ReferenceWithVelocity(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_deserialize_mrs_msgs__msg__PathWithVelocity(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__PathWithVelocity * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      mrs_msgs__msg__ReferenceWithVelocity__Sequence__fini(&ros_message->points);
    }
    if (!mrs_msgs__msg__ReferenceWithVelocity__Sequence__init(&ros_message->points, size)) {
      fprintf(stderr, "failed to create array for field 'points'");
      return false;
    }
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__ReferenceWithVelocity(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_mrs_msgs__msg__PathWithVelocity(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathWithVelocity__ros_msg_type * ros_message = static_cast<const _PathWithVelocity__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__ReferenceWithVelocity(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_mrs_msgs__msg__PathWithVelocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__ReferenceWithVelocity(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__PathWithVelocity;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_key_mrs_msgs__msg__PathWithVelocity(
  const mrs_msgs__msg__PathWithVelocity * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__ReferenceWithVelocity(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_key_mrs_msgs__msg__PathWithVelocity(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathWithVelocity__ros_msg_type * ros_message = static_cast<const _PathWithVelocity__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__ReferenceWithVelocity(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_key_mrs_msgs__msg__PathWithVelocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__ReferenceWithVelocity(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__PathWithVelocity * ros_message = static_cast<const mrs_msgs__msg__PathWithVelocity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__PathWithVelocity(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__PathWithVelocity * ros_message = static_cast<mrs_msgs__msg__PathWithVelocity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__PathWithVelocity(cdr, ros_message);
}

static uint32_t _PathWithVelocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__PathWithVelocity(
...
static size_t _PathWithVelocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__PathWithVelocity(
...
static message_type_support_callbacks_t __callbacks_PathWithVelocity = {
  "mrs_msgs::msg",
  "PathWithVelocity",
...
static rosidl_message_type_support_t _PathWithVelocity__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PathWithVelocity,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, PathWithVelocity)() {
  return &_PathWithVelocity__type_support;
}
