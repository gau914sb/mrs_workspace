...
#include "mrs_msgs/msg/detail/reference__rosidl_typesupport_fastrtps_c.h"
...
using _Reference__ros_msg_type = mrs_msgs__msg__Reference;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Reference;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Reference * ros_message = static_cast<const mrs_msgs__msg__Reference *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Reference(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Reference * ros_message = static_cast<mrs_msgs__msg__Reference *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Reference(cdr, ros_message);
}

static uint32_t _Reference__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Reference(
...
static size_t _Reference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__Reference(
