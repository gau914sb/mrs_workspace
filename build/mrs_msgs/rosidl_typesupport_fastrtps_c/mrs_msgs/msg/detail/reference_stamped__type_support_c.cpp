...
#include "mrs_msgs/msg/detail/reference_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _ReferenceStamped__ros_msg_type = mrs_msgs__msg__ReferenceStamped;
...
size_t get_serialized_size_mrs_msgs__msg__ReferenceStamped(
  ...
  size_t current_alignment)
{
  const _ReferenceStamped__ros_msg_type * ros_message = static_cast<const _ReferenceStamped__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__ReferenceStamped;
    is_plain =
      (
...
static bool _ReferenceStamped__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__ReferenceStamped * ros_message = static_cast<const mrs_msgs__msg__ReferenceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__ReferenceStamped(ros_message, cdr);
}

static bool _ReferenceStamped__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__ReferenceStamped * ros_message = static_cast<mrs_msgs__msg__ReferenceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__ReferenceStamped(cdr, ros_message);
}

static uint32_t _ReferenceStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__ReferenceStamped(
      untyped_ros_message, 0));
}

static size_t _ReferenceStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mrs_msgs__msg__ReferenceStamped(
...
static message_type_support_callbacks_t __callbacks_ReferenceStamped = {
  "mrs_msgs::msg",
  "ReferenceStamped",
  _ReferenceStamped__cdr_serialize,
  _ReferenceStamped__cdr_deserialize,
  _ReferenceStamped__get_serialized_size,
  _ReferenceStamped__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _ReferenceStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ReferenceStamped,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, ReferenceStamped)() {
  return &_ReferenceStamped__type_support;
}
