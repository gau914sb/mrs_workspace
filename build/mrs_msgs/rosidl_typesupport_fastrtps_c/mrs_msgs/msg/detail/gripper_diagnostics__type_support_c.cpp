...
#include "mrs_msgs/msg/detail/gripper_diagnostics__rosidl_typesupport_fastrtps_c.h"
...
using _GripperDiagnostics__ros_msg_type = mrs_msgs__msg__GripperDiagnostics;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_mrs_msgs__msg__GripperDiagnostics(
  const mrs_msgs__msg__GripperDiagnostics * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: stamp
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_deserialize_mrs_msgs__msg__GripperDiagnostics(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__GripperDiagnostics * ros_message)
{
  // Field name: stamp
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_mrs_msgs__msg__GripperDiagnostics(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_mrs_msgs__msg__GripperDiagnostics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__GripperDiagnostics;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_key_mrs_msgs__msg__GripperDiagnostics(
  const mrs_msgs__msg__GripperDiagnostics * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: stamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_key_mrs_msgs__msg__GripperDiagnostics(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperDiagnostics__ros_msg_type * ros_message = static_cast<const _GripperDiagnostics__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_key_mrs_msgs__msg__GripperDiagnostics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__GripperDiagnostics * ros_message = static_cast<const mrs_msgs__msg__GripperDiagnostics *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__GripperDiagnostics(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__GripperDiagnostics * ros_message = static_cast<mrs_msgs__msg__GripperDiagnostics *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__GripperDiagnostics(cdr, ros_message);
}

static uint32_t _GripperDiagnostics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__GripperDiagnostics(
...
static size_t _GripperDiagnostics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__GripperDiagnostics(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, GripperDiagnostics)() {
