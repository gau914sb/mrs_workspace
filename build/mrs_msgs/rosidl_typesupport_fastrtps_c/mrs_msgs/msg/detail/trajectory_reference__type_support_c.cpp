...
#include "mrs_msgs/msg/detail/trajectory_reference__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryReference__ros_msg_type = mrs_msgs__msg__TrajectoryReference;
...
size_t get_serialized_size_mrs_msgs__msg__TrajectoryReference(
  ...
  size_t current_alignment)
{
  const _TrajectoryReference__ros_msg_type * ros_message = static_cast<const _TrajectoryReference__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__TrajectoryReference;
    is_plain =
      (
...
static bool _TrajectoryReference__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__TrajectoryReference * ros_message = static_cast<const mrs_msgs__msg__TrajectoryReference *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__TrajectoryReference(ros_message, cdr);
}

static bool _TrajectoryReference__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__TrajectoryReference * ros_message = static_cast<mrs_msgs__msg__TrajectoryReference *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__TrajectoryReference(cdr, ros_message);
}

static uint32_t _TrajectoryReference__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__TrajectoryReference(
      untyped_ros_message, 0));
}

static size_t _TrajectoryReference__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mrs_msgs__msg__TrajectoryReference(
...
static message_type_support_callbacks_t __callbacks_TrajectoryReference = {
  "mrs_msgs::msg",
  "TrajectoryReference",
  _TrajectoryReference__cdr_serialize,
  _TrajectoryReference__cdr_deserialize,
  _TrajectoryReference__get_serialized_size,
  _TrajectoryReference__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _TrajectoryReference__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrajectoryReference,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, TrajectoryReference)() {
  return &_TrajectoryReference__type_support;
}
