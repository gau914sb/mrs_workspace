...
static const _DynamicsConstraints_type_support_symbol_names_t _DynamicsConstraints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, DynamicsConstraints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrs_msgs, msg, DynamicsConstraints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrs_msgs, msg, DynamicsConstraints)() {
  return &::mrs_msgs::msg::rosidl_typesupport_c::DynamicsConstraints_message_type_support_handle;
}
