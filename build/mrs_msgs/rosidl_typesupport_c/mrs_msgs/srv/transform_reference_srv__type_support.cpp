...
static const _TransformReferenceSrv_Request_type_support_symbol_names_t _TransformReferenceSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, srv, TransformReferenceSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrs_msgs, srv, TransformReferenceSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrs_msgs, srv, TransformReferenceSrv_Request)() {
  return &::mrs_msgs::srv::rosidl_typesupport_c::TransformReferenceSrv_Request_message_type_support_handle;
}
...
static const _TransformReferenceSrv_Response_type_support_symbol_names_t _TransformReferenceSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, srv, TransformReferenceSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrs_msgs, srv, TransformReferenceSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrs_msgs, srv, TransformReferenceSrv_Response)() {
  return &::mrs_msgs::srv::rosidl_typesupport_c::TransformReferenceSrv_Response_message_type_support_handle;
}
...
static const _TransformReferenceSrv_Event_type_support_symbol_names_t _TransformReferenceSrv_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, srv, TransformReferenceSrv_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrs_msgs, srv, TransformReferenceSrv_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrs_msgs, srv, TransformReferenceSrv_Event)() {
  return &::mrs_msgs::srv::rosidl_typesupport_c::TransformReferenceSrv_Event_message_type_support_handle;
}
...
static const _TransformReferenceSrv_type_support_symbol_names_t _TransformReferenceSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, srv, TransformReferenceSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrs_msgs, srv, TransformReferenceSrv)),
  }
};
...
static const rosidl_service_type_support_t TransformReferenceSrv_service_type_support_handle = {
  ...
  &TransformReferenceSrv_Request_message_type_support_handle,
  &TransformReferenceSrv_Response_message_type_support_handle,
  &TransformReferenceSrv_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mrs_msgs, srv, TransformReferenceSrv)() {
  return &::mrs_msgs::srv::rosidl_typesupport_c::TransformReferenceSrv_service_type_support_handle;
}
