...
mrs_msgs__msg__ControllerStatus__create(void)
{
  ...
  mrs_msgs__msg__ControllerStatus * msg = (mrs_msgs__msg__ControllerStatus *)allocator.allocate(sizeof(mrs_msgs__msg__ControllerStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrs_msgs__msg__ControllerStatus));
  bool success = mrs_msgs__msg__ControllerStatus__init(msg);
  if (!success) {
...
mrs_msgs__msg__ControllerStatus__destroy(mrs_msgs__msg__ControllerStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mrs_msgs__msg__ControllerStatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
mrs_msgs__msg__ControllerStatus__Sequence__init(mrs_msgs__msg__ControllerStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrs_msgs__msg__ControllerStatus * data = NULL;

  if (size) {
    data = (mrs_msgs__msg__ControllerStatus *)allocator.zero_allocate(size, sizeof(mrs_msgs__msg__ControllerStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrs_msgs__msg__ControllerStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mrs_msgs__msg__ControllerStatus__fini(&data[i - 1]);
      }
...
mrs_msgs__msg__ControllerStatus__Sequence__fini(mrs_msgs__msg__ControllerStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mrs_msgs__msg__ControllerStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrs_msgs__msg__ControllerStatus__Sequence * array = (mrs_msgs__msg__ControllerStatus__Sequence *)allocator.allocate(sizeof(mrs_msgs__msg__ControllerStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrs_msgs__msg__ControllerStatus__Sequence__init(array, size);
  if (!success) {
...
mrs_msgs__msg__ControllerStatus__Sequence__destroy(mrs_msgs__msg__ControllerStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrs_msgs__msg__ControllerStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrs_msgs__msg__ControllerStatus__Sequence__are_equal(const mrs_msgs__msg__ControllerStatus__Sequence * lhs, const mrs_msgs__msg__ControllerStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrs_msgs__msg__ControllerStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrs_msgs__msg__ControllerStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrs_msgs__msg__ControllerStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrs_msgs__msg__ControllerStatus * data =
      (mrs_msgs__msg__ControllerStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrs_msgs__msg__ControllerStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrs_msgs__msg__ControllerStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
