...
static char mrs_msgs__msg__ReferenceStamped__FIELD_NAME__header[] = "header";
static char mrs_msgs__msg__ReferenceStamped__FIELD_NAME__reference[] = "reference";

static rosidl_runtime_c__type_description__Field mrs_msgs__msg__ReferenceStamped__FIELDS[] = {
  {
    {mrs_msgs__msg__ReferenceStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {mrs_msgs__msg__ReferenceStamped__FIELD_NAME__reference, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrs_msgs__msg__ReferenceStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrs_msgs__msg__ReferenceStamped__FIELDS, 2, 2},
    },
    {mrs_msgs__msg__ReferenceStamped__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrs_msgs__msg__ReferenceStamped__get_individual_type_description_source(NULL),
