...
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__header[] = "header";
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__input_id[] = "input_id";
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__use_heading[] = "use_heading";
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__fly_now[] = "fly_now";
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__loop[] = "loop";
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__dt[] = "dt";
static char mrs_msgs__msg__TrajectoryReference__FIELD_NAME__points[] = "points";

static rosidl_runtime_c__type_description__Field mrs_msgs__msg__TrajectoryReference__FIELDS[] = {
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__input_id, 8, 8},
    {
  ...
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__use_heading, 11, 11},
    {
  ...
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__fly_now, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__loop, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__dt, 2, 2},
    {
  ...
  {
    {mrs_msgs__msg__TrajectoryReference__FIELD_NAME__points, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrs_msgs__msg__TrajectoryReference__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrs_msgs__msg__TrajectoryReference__FIELDS, 7, 7},
    },
    {mrs_msgs__msg__TrajectoryReference__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
mrs_msgs__msg__TrajectoryReference__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrs_msgs__msg__TrajectoryReference__get_individual_type_description_source(NULL),
