...
mrs_msgs__msg__HwApiRcChannels__init(mrs_msgs__msg__HwApiRcChannels * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    mrs_msgs__msg__HwApiRcChannels__fini(msg);
    return false;
  }
  // channels
...
mrs_msgs__msg__HwApiRcChannels__create(void)
{
  ...
  mrs_msgs__msg__HwApiRcChannels * msg = (mrs_msgs__msg__HwApiRcChannels *)allocator.allocate(sizeof(mrs_msgs__msg__HwApiRcChannels), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrs_msgs__msg__HwApiRcChannels));
  bool success = mrs_msgs__msg__HwApiRcChannels__init(msg);
  if (!success) {
...
mrs_msgs__msg__HwApiRcChannels__Sequence__init(mrs_msgs__msg__HwApiRcChannels__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrs_msgs__msg__HwApiRcChannels * data = NULL;

  if (size) {
    data = (mrs_msgs__msg__HwApiRcChannels *)allocator.zero_allocate(size, sizeof(mrs_msgs__msg__HwApiRcChannels), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrs_msgs__msg__HwApiRcChannels__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mrs_msgs__msg__HwApiRcChannels__fini(&data[i - 1]);
      }
...
mrs_msgs__msg__HwApiRcChannels__Sequence__fini(mrs_msgs__msg__HwApiRcChannels__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mrs_msgs__msg__HwApiRcChannels__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrs_msgs__msg__HwApiRcChannels__Sequence * array = (mrs_msgs__msg__HwApiRcChannels__Sequence *)allocator.allocate(sizeof(mrs_msgs__msg__HwApiRcChannels__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrs_msgs__msg__HwApiRcChannels__Sequence__init(array, size);
  if (!success) {
...
mrs_msgs__msg__HwApiRcChannels__Sequence__destroy(mrs_msgs__msg__HwApiRcChannels__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrs_msgs__msg__HwApiRcChannels__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrs_msgs__msg__HwApiRcChannels__Sequence__are_equal(const mrs_msgs__msg__HwApiRcChannels__Sequence * lhs, const mrs_msgs__msg__HwApiRcChannels__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrs_msgs__msg__HwApiRcChannels__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrs_msgs__msg__HwApiRcChannels__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrs_msgs__msg__HwApiRcChannels);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrs_msgs__msg__HwApiRcChannels * data =
      (mrs_msgs__msg__HwApiRcChannels *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrs_msgs__msg__HwApiRcChannels__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrs_msgs__msg__HwApiRcChannels__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrs_msgs__msg__HwApiRcChannels__copy(
