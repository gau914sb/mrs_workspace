  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x5c, 0x40, 0x0b, 0x89, 0x86, 0x9f, 0x89, 0xfd,
      0xd4, 0xc4, 0xe3, 0x13, 0x79, 0x98, 0x52, 0x26,
      0x30, 0x38, 0xd1, 0x84, 0x6f, 0x61, 0x80, 0xca,
      0xaa, 0x19, 0xff, 0xb2, 0x01, 0x85, 0xfd, 0x50,
    }};
  return &hash;
}
...
static char mrs_msgs__msg__UavState__TYPE_NAME[] = "mrs_msgs/msg/UavState";
...
static char mrs_msgs__msg__UavState__FIELD_NAME__header[] = "header";
static char mrs_msgs__msg__UavState__FIELD_NAME__child_frame_id[] = "child_frame_id";
static char mrs_msgs__msg__UavState__FIELD_NAME__estimator_horizontal[] = "estimator_horizontal";
static char mrs_msgs__msg__UavState__FIELD_NAME__estimator_vertical[] = "estimator_vertical";
static char mrs_msgs__msg__UavState__FIELD_NAME__estimator_heading[] = "estimator_heading";
static char mrs_msgs__msg__UavState__FIELD_NAME__estimator_iteration[] = "estimator_iteration";
static char mrs_msgs__msg__UavState__FIELD_NAME__pose[] = "pose";
static char mrs_msgs__msg__UavState__FIELD_NAME__velocity[] = "velocity";
static char mrs_msgs__msg__UavState__FIELD_NAME__acceleration[] = "acceleration";
static char mrs_msgs__msg__UavState__FIELD_NAME__acceleration_disturbance[] = "acceleration_disturbance";

static rosidl_runtime_c__type_description__Field mrs_msgs__msg__UavState__FIELDS[] = {
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__child_frame_id, 14, 14},
    {
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__estimator_horizontal, 20, 20},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__estimator_vertical, 18, 18},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__estimator_heading, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__estimator_iteration, 19, 19},
    {
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__velocity, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__acceleration, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__UavState__FIELD_NAME__acceleration_disturbance, 24, 24},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrs_msgs__msg__UavState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {mrs_msgs__msg__UavState__TYPE_NAME, 21, 21},
      {mrs_msgs__msg__UavState__FIELDS, 10, 10},
    },
    {mrs_msgs__msg__UavState__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
mrs_msgs__msg__UavState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrs_msgs__msg__UavState__get_individual_type_description_source(NULL),
