...
static char mrs_msgs__msg__ErrorgraphElement__FIELD_NAME__stamp[] = "stamp";
static char mrs_msgs__msg__ErrorgraphElement__FIELD_NAME__source_node[] = "source_node";
static char mrs_msgs__msg__ErrorgraphElement__FIELD_NAME__errors[] = "errors";

static rosidl_runtime_c__type_description__Field mrs_msgs__msg__ErrorgraphElement__FIELDS[] = {
  {
    {mrs_msgs__msg__ErrorgraphElement__FIELD_NAME__stamp, 5, 5},
    {
  ...
  {
    {mrs_msgs__msg__ErrorgraphElement__FIELD_NAME__source_node, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__ErrorgraphElement__FIELD_NAME__errors, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrs_msgs__msg__ErrorgraphElement__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrs_msgs__msg__ErrorgraphElement__FIELDS, 3, 3},
    },
    {mrs_msgs__msg__ErrorgraphElement__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = mrs_msgs__msg__ErrorgraphError__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[2].fields = mrs_msgs__msg__ErrorgraphNodeID__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "mrs_msgs/ErrorgraphNodeID source_node\n"
  "\n"
  "mrs_msgs/ErrorgraphError[] errors";
...
mrs_msgs__msg__ErrorgraphElement__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrs_msgs__msg__ErrorgraphElement__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *mrs_msgs__msg__ErrorgraphError__get_individual_type_description_source(NULL);
    sources[3] = *mrs_msgs__msg__ErrorgraphNodeID__get_individual_type_description_source(NULL);
    constructed = true;
  }
