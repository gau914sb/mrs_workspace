...
static char mrs_msgs__msg__ErrorgraphError__FIELD_NAME__stamp[] = "stamp";
static char mrs_msgs__msg__ErrorgraphError__FIELD_NAME__type[] = "type";
static char mrs_msgs__msg__ErrorgraphError__FIELD_NAME__waited_for_topic[] = "waited_for_topic";
static char mrs_msgs__msg__ErrorgraphError__FIELD_NAME__waited_for_node[] = "waited_for_node";

static rosidl_runtime_c__type_description__Field mrs_msgs__msg__ErrorgraphError__FIELDS[] = {
  {
    {mrs_msgs__msg__ErrorgraphError__FIELD_NAME__stamp, 5, 5},
    {
  ...
  {
    {mrs_msgs__msg__ErrorgraphError__FIELD_NAME__type, 4, 4},
    {
  ...
  {
    {mrs_msgs__msg__ErrorgraphError__FIELD_NAME__waited_for_topic, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {mrs_msgs__msg__ErrorgraphError__FIELD_NAME__waited_for_node, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrs_msgs__msg__ErrorgraphError__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrs_msgs__msg__ErrorgraphError__FIELDS, 4, 4},
    },
    {mrs_msgs__msg__ErrorgraphError__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = mrs_msgs__msg__ErrorgraphNodeID__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "mrs_msgs/ErrorgraphNodeID waited_for_node\n"
  "\n"
...
mrs_msgs__msg__ErrorgraphError__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrs_msgs__msg__ErrorgraphError__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *mrs_msgs__msg__ErrorgraphNodeID__get_individual_type_description_source(NULL);
    constructed = true;
  }
