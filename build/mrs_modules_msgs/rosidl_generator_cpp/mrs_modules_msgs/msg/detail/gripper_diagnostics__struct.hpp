...
#ifndef MRS_MODULES_MSGS__MSG__DETAIL__GRIPPER_DIAGNOSTICS__STRUCT_HPP_
#define MRS_MODULES_MSGS__MSG__DETAIL__GRIPPER_DIAGNOSTICS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mrs_modules_msgs__msg__GripperDiagnostics __attribute__((deprecated))
#else
# define DEPRECATED__mrs_modules_msgs__msg__GripperDiagnostics __declspec(deprecated)
#endif
...
struct GripperDiagnostics_
{
  ...
  // pointer types
  using RawPtr =
    mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator> *;
  using ConstRawPtr =
    const mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mrs_modules_msgs__msg__GripperDiagnostics
    std::shared_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mrs_modules_msgs__msg__GripperDiagnostics
    std::shared_ptr<mrs_modules_msgs::msg::GripperDiagnostics_<ContainerAllocator> const>
...
using GripperDiagnostics =
  mrs_modules_msgs::msg::GripperDiagnostics_<std::allocator<void>>;
...
#endif  // MRS_MODULES_MSGS__MSG__DETAIL__GRIPPER_DIAGNOSTICS__STRUCT_HPP_
