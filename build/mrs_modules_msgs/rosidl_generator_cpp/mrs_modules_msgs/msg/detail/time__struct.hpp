...
#ifndef MRS_MODULES_MSGS__MSG__DETAIL__TIME__STRUCT_HPP_
#define MRS_MODULES_MSGS__MSG__DETAIL__TIME__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mrs_modules_msgs__msg__Time __attribute__((deprecated))
#else
# define DEPRECATED__mrs_modules_msgs__msg__Time __declspec(deprecated)
#endif
...
struct Time_
{
  ...
  using _utc_minute_type =
    uint8_t;
  _utc_minute_type utc_minute;
  using _utc_millisecond_type =
    uint32_t;
  ...
  Type & set__utc_minute(
    const uint8_t & _arg)
  {
    this->utc_minute = _arg;
    return *this;
  }
  Type & set__utc_millisecond(
    const uint32_t & _arg)
  {
    this->utc_millisecond = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    mrs_modules_msgs::msg::Time_<ContainerAllocator> *;
  using ConstRawPtr =
    const mrs_modules_msgs::msg::Time_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mrs_modules_msgs::msg::Time_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mrs_modules_msgs__msg__Time
    std::shared_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mrs_modules_msgs__msg__Time
    std::shared_ptr<mrs_modules_msgs::msg::Time_<ContainerAllocator> const>
  ...
  bool operator==(const Time_ & other) const
  {
    ...
    if (this->utc_minute != other.utc_minute) {
      return false;
    }
    if (this->utc_millisecond != other.utc_millisecond) {
      return false;
    }
...
using Time =
  mrs_modules_msgs::msg::Time_<std::allocator<void>>;
...
#endif  // MRS_MODULES_MSGS__MSG__DETAIL__TIME__STRUCT_HPP_
