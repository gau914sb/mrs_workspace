...
#ifndef MRS_MODULES_MSGS__MSG__DETAIL__GPGSA__TRAITS_HPP_
#define MRS_MODULES_MSGS__MSG__DETAIL__GPGSA__TRAITS_HPP_
...
inline void to_yaml(
  const mrs_modules_msgs::msg::Gpgsa & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mrs_modules_msgs::msg::Gpgsa & msg)
{
  return mrs_modules_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mrs_modules_msgs::msg::Gpgsa>()
{
  return "mrs_modules_msgs::msg::Gpgsa";
}

template<>
inline const char * name<mrs_modules_msgs::msg::Gpgsa>()
{
  return "mrs_modules_msgs/msg/Gpgsa";
}

template<>
struct has_fixed_size<mrs_modules_msgs::msg::Gpgsa>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mrs_modules_msgs::msg::Gpgsa>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<mrs_modules_msgs::msg::Gpgsa>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MRS_MODULES_MSGS__MSG__DETAIL__GPGSA__TRAITS_HPP_
