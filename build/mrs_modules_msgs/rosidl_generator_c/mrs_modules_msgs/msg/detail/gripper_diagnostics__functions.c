...
mrs_modules_msgs__msg__GripperDiagnostics__init(mrs_modules_msgs__msg__GripperDiagnostics * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    mrs_modules_msgs__msg__GripperDiagnostics__fini(msg);
    return false;
  }
  // gripper_on
  // gripping_object
...
mrs_modules_msgs__msg__GripperDiagnostics__create(void)
{
  ...
  mrs_modules_msgs__msg__GripperDiagnostics * msg = (mrs_modules_msgs__msg__GripperDiagnostics *)allocator.allocate(sizeof(mrs_modules_msgs__msg__GripperDiagnostics), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrs_modules_msgs__msg__GripperDiagnostics));
  bool success = mrs_modules_msgs__msg__GripperDiagnostics__init(msg);
  if (!success) {
...
mrs_modules_msgs__msg__GripperDiagnostics__Sequence__init(mrs_modules_msgs__msg__GripperDiagnostics__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrs_modules_msgs__msg__GripperDiagnostics * data = NULL;

  if (size) {
    data = (mrs_modules_msgs__msg__GripperDiagnostics *)allocator.zero_allocate(size, sizeof(mrs_modules_msgs__msg__GripperDiagnostics), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrs_modules_msgs__msg__GripperDiagnostics__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mrs_modules_msgs__msg__GripperDiagnostics__fini(&data[i - 1]);
      }
...
mrs_modules_msgs__msg__GripperDiagnostics__Sequence__fini(mrs_modules_msgs__msg__GripperDiagnostics__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mrs_modules_msgs__msg__GripperDiagnostics__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrs_modules_msgs__msg__GripperDiagnostics__Sequence * array = (mrs_modules_msgs__msg__GripperDiagnostics__Sequence *)allocator.allocate(sizeof(mrs_modules_msgs__msg__GripperDiagnostics__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrs_modules_msgs__msg__GripperDiagnostics__Sequence__init(array, size);
  if (!success) {
...
mrs_modules_msgs__msg__GripperDiagnostics__Sequence__destroy(mrs_modules_msgs__msg__GripperDiagnostics__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrs_modules_msgs__msg__GripperDiagnostics__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrs_modules_msgs__msg__GripperDiagnostics__Sequence__are_equal(const mrs_modules_msgs__msg__GripperDiagnostics__Sequence * lhs, const mrs_modules_msgs__msg__GripperDiagnostics__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrs_modules_msgs__msg__GripperDiagnostics__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrs_modules_msgs__msg__GripperDiagnostics__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrs_modules_msgs__msg__GripperDiagnostics);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrs_modules_msgs__msg__GripperDiagnostics * data =
      (mrs_modules_msgs__msg__GripperDiagnostics *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrs_modules_msgs__msg__GripperDiagnostics__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrs_modules_msgs__msg__GripperDiagnostics__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrs_modules_msgs__msg__GripperDiagnostics__copy(
