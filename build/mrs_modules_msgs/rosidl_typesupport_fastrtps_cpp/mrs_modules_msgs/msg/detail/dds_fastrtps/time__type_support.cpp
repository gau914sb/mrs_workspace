...
#include "mrs_modules_msgs/msg/detail/time__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::Time;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Time *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::Time *>(
    untyped_ros_message);
...
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Time__handle;
}
