...
#include "mrs_modules_msgs/msg/detail/trackstat_channel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_modules_msgs::msg::TrackstatChannel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::msg::TrackstatChannel & ros_message)
{
  // Member: prn
  cdr >> ros_message.prn;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::TrackstatChannel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::TrackstatChannel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::TrackstatChannel *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrackstatChannel__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::TrackstatChannel *>(
...
static size_t _TrackstatChannel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrackstatChannel(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrackstatChannel__callbacks = {
...
static rosidl_message_type_support_t _TrackstatChannel__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrackstatChannel__callbacks,
...
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_TrackstatChannel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, msg, TrackstatChannel)() {
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_TrackstatChannel__handle;
}
