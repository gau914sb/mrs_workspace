...
#include "mrs_modules_msgs/msg/detail/gpgst__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_modules_msgs::msg::Gpgst & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::msg::Gpgst & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::Gpgst;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Gpgst *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::Gpgst *>(
    untyped_ros_message);
...
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Gpgst__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, msg, Gpgst)() {
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Gpgst__handle;
}
