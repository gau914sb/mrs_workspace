...
#include "mrs_modules_msgs/msg/detail/gpgsv__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mrs_modules_msgs::msg::Satellite &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mrs_modules_msgs::msg::Satellite &);
size_t get_serialized_size(
  const mrs_modules_msgs::msg::Satellite &,
  size_t current_alignment);
size_t
max_serialized_size_Satellite(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
bool cdr_serialize_key(
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_Satellite(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const mrs_modules_msgs::msg::Gpgsv & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::msg::Gpgsv & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: satellites
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_modules_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Satellite(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::Gpgsv;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: satellites
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_modules_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Satellite(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Gpgsv *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::Gpgsv *>(
    untyped_ros_message);
...
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Gpgsv__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, msg, Gpgsv)() {
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Gpgsv__handle;
}
