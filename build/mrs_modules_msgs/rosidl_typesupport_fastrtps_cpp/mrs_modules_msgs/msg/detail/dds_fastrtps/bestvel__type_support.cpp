...
#include "mrs_modules_msgs/msg/detail/bestvel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_modules_msgs::msg::Bestvel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::msg::Bestvel & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::Bestvel;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_modules_msgs
max_serialized_size_key_Bestvel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Bestvel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::Bestvel *>(
    untyped_ros_message);
...
get_message_type_support_handle<mrs_modules_msgs::msg::Bestvel>()
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Bestvel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, msg, Bestvel)() {
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Bestvel__handle;
}
