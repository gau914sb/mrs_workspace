...
#include "mrs_modules_msgs/msg/detail/gpgga__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_modules_msgs::msg::Gpgga & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: latitude_dir
  cdr << ros_message.latitude_dir;

  // Member: longitude_dir
  cdr << ros_message.longitude_dir;

  // Member: gps_quality
  mrs_modules_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.gps_quality,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::msg::Gpgga & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::Gpgga;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Gpgga *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::Gpgga *>(
    untyped_ros_message);
...
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Gpgga__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, msg, Gpgga)() {
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Gpgga__handle;
}
