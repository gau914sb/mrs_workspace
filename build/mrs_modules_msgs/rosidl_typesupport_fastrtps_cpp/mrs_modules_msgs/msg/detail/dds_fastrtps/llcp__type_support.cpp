...
#include "mrs_modules_msgs/msg/detail/llcp__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_modules_msgs::msg::Llcp & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::msg::Llcp & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::msg::Llcp;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Llcp *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::msg::Llcp *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Llcp__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::msg::Llcp *>(
...
static size_t _Llcp__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Llcp(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Llcp__callbacks = {
...
static rosidl_message_type_support_t _Llcp__handle = {
...
{
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Llcp__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, msg, Llcp)() {
  return &mrs_modules_msgs::msg::typesupport_fastrtps_cpp::_Llcp__handle;
}
