...
#include "mrs_modules_msgs/srv/detail/set_servo__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_modules_msgs::srv::SetServo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::srv::SetServo_Request & ros_message)
{
  // Member: servo1_val
  cdr >> ros_message.servo1_val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs::srv::SetServo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::srv::SetServo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::srv::SetServo_Request *>(
    untyped_ros_message);
...
{
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, srv, SetServo_Request)() {
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_modules_msgs
cdr_serialize(
  const mrs_modules_msgs::srv::SetServo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::srv::SetServo_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mrs_modules_msgs::srv::SetServo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::srv::SetServo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::srv::SetServo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, srv, SetServo_Response)() {
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo_Response__handle;
}
...
// functions for mrs_modules_msgs::srv::SetServo_Request already declared above

// functions for mrs_modules_msgs::srv::SetServo_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_modules_msgs
cdr_serialize(
  const mrs_modules_msgs::srv::SetServo_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs::srv::SetServo_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_modules_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetServo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_modules_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetServo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mrs_modules_msgs::srv::SetServo_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_modules_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetServo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_modules_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetServo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_modules_msgs::srv::SetServo_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mrs_modules_msgs::srv::SetServo_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, srv, SetServo_Event)() {
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo_Event__handle;
}
...
static const rosidl_service_type_support_t _SetServo__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mrs_modules_msgs::srv::SetServo_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mrs_modules_msgs::srv::SetServo_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mrs_modules_msgs::srv::SetServo_Event>(),
...
{
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_modules_msgs, srv, SetServo)() {
  return &mrs_modules_msgs::srv::typesupport_fastrtps_cpp::_SetServo__handle;
}
