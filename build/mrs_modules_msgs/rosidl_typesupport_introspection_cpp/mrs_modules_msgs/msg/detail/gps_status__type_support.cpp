...
{
  new (message_memory) mrs_modules_msgs::msg::GpsStatus(_init);
}

void GpsStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_modules_msgs::msg::GpsStatus *>(message_memory);
  typed_message->~GpsStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GpsStatus_message_member_array[1] = {
  {
    "quality",  // name
    ...
    offsetof(mrs_modules_msgs::msg::GpsStatus, quality),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GpsStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(mrs_modules_msgs::msg::GpsStatus),
...
get_message_type_support_handle<mrs_modules_msgs::msg::GpsStatus>()
{
  return &::mrs_modules_msgs::msg::rosidl_typesupport_introspection_cpp::GpsStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_modules_msgs, msg, GpsStatus)() {
  return &::mrs_modules_msgs::msg::rosidl_typesupport_introspection_cpp::GpsStatus_message_type_support_handle;
}
