...
{
  new (message_memory) mrs_modules_msgs::msg::Gpgsv(_init);
}

void Gpgsv_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_modules_msgs::msg::Gpgsv *>(message_memory);
  typed_message->~Gpgsv();
}

size_t size_function__Gpgsv__satellites(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<mrs_modules_msgs::msg::Satellite> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<mrs_modules_msgs::msg::Satellite> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<mrs_modules_msgs::msg::Satellite> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const mrs_modules_msgs::msg::Satellite *>(
    get_const_function__Gpgsv__satellites(untyped_member, index));
  auto & value = *reinterpret_cast<mrs_modules_msgs::msg::Satellite *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<mrs_modules_msgs::msg::Satellite *>(
    get_function__Gpgsv__satellites(untyped_member, index));
  const auto & value = *reinterpret_cast<const mrs_modules_msgs::msg::Satellite *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Gpgsv_message_member_array[6] = {
  {
    ...
    offsetof(mrs_modules_msgs::msg::Gpgsv, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_modules_msgs::msg::Gpgsv, message_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_modules_msgs::msg::Gpgsv, n_msgs),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_modules_msgs::msg::Gpgsv, msg_number),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_modules_msgs::msg::Gpgsv, n_satellites),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<mrs_modules_msgs::msg::Satellite>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_modules_msgs::msg::Gpgsv, satellites),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Gpgsv_message_members = {
  ...
  "Gpgsv",  // message name
  6,  // number of fields
  sizeof(mrs_modules_msgs::msg::Gpgsv),
...
get_message_type_support_handle<mrs_modules_msgs::msg::Gpgsv>()
{
  return &::mrs_modules_msgs::msg::rosidl_typesupport_introspection_cpp::Gpgsv_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_modules_msgs, msg, Gpgsv)() {
  return &::mrs_modules_msgs::msg::rosidl_typesupport_introspection_cpp::Gpgsv_message_type_support_handle;
}
