...
bool mrs_modules_msgs__msg__gps_fix__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_modules_msgs.msg._gps_fix.GPSFix", full_classname_dest, 36) == 0);
  }
  mrs_modules_msgs__msg__GPSFix * ros_message = _ros_message;
  {  // header
  ...
  {  // status
    ...
    if (!mrs_modules_msgs__msg__gps_status__convert_from_py(field, &ros_message->status)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * mrs_modules_msgs__msg__gps_fix__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_modules_msgs.msg._gps_fix");
  ...
  {  // status
    PyObject * field = NULL;
    field = mrs_modules_msgs__msg__gps_status__convert_to_py(&ros_message->status);
    if (!field) {
      return NULL;
    }
    {
