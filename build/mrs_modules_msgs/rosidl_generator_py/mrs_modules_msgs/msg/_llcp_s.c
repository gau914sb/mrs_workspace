...
bool mrs_modules_msgs__msg__llcp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_modules_msgs.msg._llcp.Llcp", full_classname_dest, 31) == 0);
  }
  mrs_modules_msgs__msg__Llcp * ros_message = _ros_message;
  {  // stamp
  ...
  {  // checksum_matched
    PyObject * field = PyObject_GetAttrString(_pymsg, "checksum_matched");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->checksum_matched = (Py_True == field);
    Py_DECREF(field);
  }
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Llcp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_modules_msgs.msg._llcp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Llcp");
  ...
  {  // checksum_matched
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->checksum_matched ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "checksum_matched", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
