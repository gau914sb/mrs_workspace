...
bool mrs_modules_msgs__msg__serial_raw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_modules_msgs.msg._serial_raw.SerialRaw", full_classname_dest, 42) == 0);
  }
  mrs_modules_msgs__msg__SerialRaw * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of SerialRaw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_modules_msgs.msg._serial_raw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SerialRaw");
