...
class Metaclass_Gpgsv(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mrs_modules_msgs.msg import Satellite
            if Satellite.__class__._TYPE_SUPPORT is None:
                Satellite.__class__.__import_type_support__()
...
class Gpgsv(metaclass=Metaclass_Gpgsv):
    ...
    _fields_and_field_types = {
        ...
        'msg_number': 'uint8',
        'n_satellites': 'uint8',
        'satellites': 'sequence<mrs_modules_msgs/Satellite>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mrs_modules_msgs', 'msg'], 'Satellite')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Satellite) for v in value) and
                 True), \
                "The 'satellites' field must be a set or sequence and each value of type 'Satellite'"
