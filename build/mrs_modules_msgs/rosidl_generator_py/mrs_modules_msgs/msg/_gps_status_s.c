...
bool mrs_modules_msgs__msg__gps_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_modules_msgs.msg._gps_status.GpsStatus", full_classname_dest, 42) == 0);
  }
  mrs_modules_msgs__msg__GpsStatus * ros_message = _ros_message;
  {  // quality
    ...
    ros_message->quality = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * mrs_modules_msgs__msg__gps_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_modules_msgs.msg._gps_status");
