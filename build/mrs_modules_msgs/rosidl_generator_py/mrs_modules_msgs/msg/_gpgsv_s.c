...
bool mrs_modules_msgs__msg__gpgsv__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_modules_msgs.msg._gpgsv.Gpgsv", full_classname_dest, 33) == 0);
  }
  mrs_modules_msgs__msg__Gpgsv * ros_message = _ros_message;
  {  // header
  ...
  {  // satellites
    ...
    if (!mrs_modules_msgs__msg__Satellite__Sequence__init(&(ros_message->satellites), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mrs_modules_msgs__msg__Satellite__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mrs_modules_msgs__msg__Satellite * dest = ros_message->satellites.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mrs_modules_msgs__msg__satellite__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * mrs_modules_msgs__msg__gpgsv__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_modules_msgs.msg._gpgsv");
  ...
  {  // satellites
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mrs_modules_msgs__msg__satellite__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
