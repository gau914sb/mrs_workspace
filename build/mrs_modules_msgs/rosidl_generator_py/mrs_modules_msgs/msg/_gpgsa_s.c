...
bool mrs_modules_msgs__msg__gpgsa__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_modules_msgs.msg._gpgsa.Gpgsa", full_classname_dest, 33) == 0);
  }
  mrs_modules_msgs__msg__Gpgsa * ros_message = _ros_message;
  {  // header
  ...
  {  // auto_manual_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "auto_manual_mode");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->auto_manual_mode, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // fix_mode
  ...
  {  // prn
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->prn.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'prn'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of Gpgsa */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_modules_msgs.msg._gpgsa");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Gpgsa");
  ...
  {  // auto_manual_mode
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->auto_manual_mode.data,
      strlen(ros_message->auto_manual_mode.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "auto_manual_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // prn
    ...
    if (ros_message->prn.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->prn.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->prn.size * sizeof(uint8_t));
      assert(data != NULL);
