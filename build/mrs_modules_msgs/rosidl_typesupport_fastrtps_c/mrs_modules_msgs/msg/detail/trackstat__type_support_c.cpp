...
#include "mrs_modules_msgs/msg/detail/trackstat__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_modules_msgs/msg/detail/trackstat_channel__functions.h"  // channels
#include "rosidl_runtime_c/string.h"  // position_type, solution_status
#include "rosidl_runtime_c/string_functions.h"  // position_type, solution_status
...
using _Trackstat__ros_msg_type = mrs_modules_msgs__msg__Trackstat;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
bool cdr_serialize_mrs_modules_msgs__msg__Trackstat(
  const mrs_modules_msgs__msg__Trackstat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: channels
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_modules_msgs__msg__TrackstatChannel(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
bool cdr_deserialize_mrs_modules_msgs__msg__Trackstat(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs__msg__Trackstat * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: channels
  {
    ...
    if (ros_message->channels.data) {
      mrs_modules_msgs__msg__TrackstatChannel__Sequence__fini(&ros_message->channels);
    }
    ...
    auto array_ptr = ros_message->channels.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_modules_msgs__msg__TrackstatChannel(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t get_serialized_size_mrs_modules_msgs__msg__Trackstat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trackstat__ros_msg_type * ros_message = static_cast<const _Trackstat__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: channels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_modules_msgs__msg__TrackstatChannel(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t max_serialized_size_mrs_modules_msgs__msg__Trackstat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: channels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_modules_msgs__msg__TrackstatChannel(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs__msg__Trackstat;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
bool cdr_serialize_key_mrs_modules_msgs__msg__Trackstat(
  const mrs_modules_msgs__msg__Trackstat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: channels
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_modules_msgs__msg__TrackstatChannel(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t get_serialized_size_key_mrs_modules_msgs__msg__Trackstat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trackstat__ros_msg_type * ros_message = static_cast<const _Trackstat__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: channels
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_modules_msgs__msg__TrackstatChannel(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t max_serialized_size_key_mrs_modules_msgs__msg__Trackstat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: channels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_modules_msgs__msg__TrackstatChannel(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_modules_msgs__msg__Trackstat * ros_message = static_cast<const mrs_modules_msgs__msg__Trackstat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_modules_msgs__msg__Trackstat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_modules_msgs__msg__Trackstat * ros_message = static_cast<mrs_modules_msgs__msg__Trackstat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_modules_msgs__msg__Trackstat(cdr, ros_message);
}

static uint32_t _Trackstat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_modules_msgs__msg__Trackstat(
...
static size_t _Trackstat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_modules_msgs__msg__Trackstat(
...
static message_type_support_callbacks_t __callbacks_Trackstat = {
...
static rosidl_message_type_support_t _Trackstat__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Trackstat,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_modules_msgs, msg, Trackstat)() {
  return &_Trackstat__type_support;
}
