...
#include "mrs_modules_msgs/msg/detail/range_information__rosidl_typesupport_fastrtps_c.h"
...
using _RangeInformation__ros_msg_type = mrs_modules_msgs__msg__RangeInformation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: noise_density_ratio
  {
...
{
  const _RangeInformation__ros_msg_type * ros_message = static_cast<const _RangeInformation__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs__msg__RangeInformation;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_modules_msgs__msg__RangeInformation * ros_message = static_cast<const mrs_modules_msgs__msg__RangeInformation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_modules_msgs__msg__RangeInformation(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_modules_msgs__msg__RangeInformation * ros_message = static_cast<mrs_modules_msgs__msg__RangeInformation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_modules_msgs__msg__RangeInformation(cdr, ros_message);
}

static uint32_t _RangeInformation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_modules_msgs__msg__RangeInformation(
...
static size_t _RangeInformation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_modules_msgs__msg__RangeInformation(
...
static message_type_support_callbacks_t __callbacks_RangeInformation = {
...
static rosidl_message_type_support_t _RangeInformation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RangeInformation,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_modules_msgs, msg, RangeInformation)() {
  return &_RangeInformation__type_support;
}
