...
#include "mrs_modules_msgs/msg/detail/gpgsv__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_modules_msgs/msg/detail/satellite__functions.h"  // satellites
...
using _Gpgsv__ros_msg_type = mrs_modules_msgs__msg__Gpgsv;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: satellites
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_modules_msgs__msg__Satellite(
        &array_ptr[i], cdr);
    }
  }
  ...
  mrs_modules_msgs__msg__Gpgsv * ros_message)
{
  ...
  // Field name: satellites
  {
    ...
    if (ros_message->satellites.data) {
      mrs_modules_msgs__msg__Satellite__Sequence__fini(&ros_message->satellites);
    }
    if (!mrs_modules_msgs__msg__Satellite__Sequence__init(&ros_message->satellites, size)) {
      fprintf(stderr, "failed to create array for field 'satellites'");
      return false;
    }
    auto array_ptr = ros_message->satellites.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_modules_msgs__msg__Satellite(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: satellites
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_modules_msgs__msg__Satellite(
  ...
  size_t current_alignment)
{
  ...
  // Field name: satellites
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_modules_msgs__msg__Satellite(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs__msg__Gpgsv;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: satellites
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_modules_msgs__msg__Satellite(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: satellites
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_modules_msgs__msg__Satellite(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: satellites
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_modules_msgs__msg__Satellite(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_modules_msgs__msg__Gpgsv * ros_message = static_cast<const mrs_modules_msgs__msg__Gpgsv *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_modules_msgs__msg__Gpgsv(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_modules_msgs__msg__Gpgsv * ros_message = static_cast<mrs_modules_msgs__msg__Gpgsv *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_modules_msgs__msg__Gpgsv(cdr, ros_message);
}

static uint32_t _Gpgsv__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_modules_msgs__msg__Gpgsv(
...
static size_t _Gpgsv__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_modules_msgs__msg__Gpgsv(
