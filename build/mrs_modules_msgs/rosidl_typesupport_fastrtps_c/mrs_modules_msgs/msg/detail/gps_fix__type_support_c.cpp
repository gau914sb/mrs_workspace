...
#include "mrs_modules_msgs/msg/detail/gps_fix__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_modules_msgs/msg/detail/gps_status__functions.h"  // status
...
using _GPSFix__ros_msg_type = mrs_modules_msgs__msg__GPSFix;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
bool cdr_serialize_mrs_modules_msgs__msg__GPSFix(
  const mrs_modules_msgs__msg__GPSFix * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
bool cdr_deserialize_mrs_modules_msgs__msg__GPSFix(
  eprosima::fastcdr::Cdr & cdr,
  mrs_modules_msgs__msg__GPSFix * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: status
  {
    cdr_deserialize_mrs_modules_msgs__msg__GpsStatus(cdr, &ros_message->status);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t get_serialized_size_mrs_modules_msgs__msg__GPSFix(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t max_serialized_size_mrs_modules_msgs__msg__GPSFix(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_modules_msgs__msg__GPSFix;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
bool cdr_serialize_key_mrs_modules_msgs__msg__GPSFix(
  const mrs_modules_msgs__msg__GPSFix * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t get_serialized_size_key_mrs_modules_msgs__msg__GPSFix(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GPSFix__ros_msg_type * ros_message = static_cast<const _GPSFix__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_modules_msgs
size_t max_serialized_size_key_mrs_modules_msgs__msg__GPSFix(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_modules_msgs__msg__GPSFix * ros_message = static_cast<const mrs_modules_msgs__msg__GPSFix *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_modules_msgs__msg__GPSFix(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_modules_msgs__msg__GPSFix * ros_message = static_cast<mrs_modules_msgs__msg__GPSFix *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_modules_msgs__msg__GPSFix(cdr, ros_message);
}

static uint32_t _GPSFix__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_modules_msgs__msg__GPSFix(
...
static size_t _GPSFix__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_modules_msgs__msg__GPSFix(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_modules_msgs, msg, GPSFix)() {
